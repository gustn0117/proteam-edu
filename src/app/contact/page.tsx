        ...
        <div className="grid sm:grid-cols-3 gap-5 mb-6 animate-fade-in-up">
          <div className="group bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="p-6 md:p-8 text-center">
              ...
              <p className="text-base font-bold text-gray-900">02-6677-3868</p>
            </div>
          </div>
          <div className="group bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="p-6 md:p-8 text-center">
              ...
              <p className="text-base font-bold text-gray-900">edu@proteamip.com</p>
            </div>
          </div>
          <div className="group bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="p-6 md:p-8 text-center">
              ...
              <p className="text-base font-bold text-gray-900">서울시 강남구 선릉로 529, 5층 5302호</p>
            </div>
          </div>
        </div>
