        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden animate-fade-in-up">
          <div className="grid sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-gray-100">
            <div className="group p-6 md:p-8 text-center hover:bg-slate-50/50 transition-colors">
              <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-primary/5 to-primary/10 text-primary flex items-center justify-center mx-auto mb-4 group-hover:from-gold/10 group-hover:to-gold/20 group-hover:text-gold transition-all duration-300">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" /></svg>
              </div>
              <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">전화</p>
              <p className="text-sm font-semibold text-gray-900">02-0000-0000</p>
            </div>
            <div className="group p-6 md:p-8 text-center hover:bg-slate-50/50 transition-colors">
              <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-primary/5 to-primary/10 text-primary flex items-center justify-center mx-auto mb-4 group-hover:from-gold/10 group-hover:to-gold/20 group-hover:text-gold transition-all duration-300">
              ...
              <p className="text-sm font-semibold text-gray-900">edu@proteambiz.com</p>
            </div>
            <div className="group p-6 md:p-8 text-center hover:bg-slate-50/50 transition-colors">
              <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-primary/5 to-primary/10 text-primary flex items-center justify-center mx-auto mb-4 group-hover:from-gold/10 group-hover:to-gold/20 group-hover:text-gold transition-all duration-300">
              ...
              <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">주소</p>
              <p className="text-sm font-semibold text-gray-900">서울특별시</p>
            </div>
          </div>
          ...
          <div className="p-8 md:p-10 border-t border-gray-100">
            ...
            <div className="space-y-4">
              <div className="flex gap-4 items-start">
                <span className="shrink-0 text-xs font-semibold bg-primary/5 text-primary px-3 py-1.5 rounded-lg mt-0.5">계좌이체</span>
                <p className="text-sm text-gray-600 leading-relaxed">국민 829-01-0308-009, ㈜프로앤팀</p>
              </div>
              <div className="flex gap-4 items-start">
                <span className="shrink-0 text-xs font-semibold bg-primary/5 text-primary px-3 py-1.5 rounded-lg mt-0.5">계산서 발급</span>
                <p className="text-sm text-gray-600 leading-relaxed">사업자등록증 사본, 계산서 담당자 메일주소, 연락처를 edu@proteambiz.com으로 송부</p>
              </div>
              <div className="flex gap-4 items-start">
                <span className="shrink-0 text-xs font-semibold bg-primary/5 text-primary px-3 py-1.5 rounded-lg mt-0.5">현금영수증</span>
